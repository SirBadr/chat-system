...
ActiveRecord::Schema.define(version: 20220712133746) do

  create_table "apps", primary_key: "token", id: :string, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3" do |t|
